...
public class FloydWarshallAlgorithm {
    ...
    public void applyAlgorithm() {
        ...
        for (Edge edge : edges) {
            ...
            distMatrix[edge.getEndVertexId()][edge.getStartVertexId()] = edge.getDistance(); 			// dwie strony
            nextVertexMatrix[edge.getEndVertexId()][edge.getStartVertexId()] = edge.getStartVertexId(); // ma dzialac
        }
